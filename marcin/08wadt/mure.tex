...
\eq{ 
\<x_1...x_n\>\in R^A\ \impl \<\phi(x_1)...\phi(x_n)\>\in R^B
\label{eq:weak}}
...
epi-mono factorization & +  & +  & -- \\ \hline %\vspace*{-2ex}
\end{tabular}
\end{center}
...
homomorphisms).\addtocounter{footnote}{1}\footnotetext{The literature 
on partial algebras calls tight
homomorphisms {\em closed} and the full injective ones
{\em  relative-injective}.}
